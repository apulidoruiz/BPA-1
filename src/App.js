    ...
    subareas:[
      {
        ...
        processes:[
          ...
          { id:"CVP03", code:"CVP03", name:"Negociación con Proveedores",
            ...
            erp:["CO","CP","CI"], systems:["Portal Proveedores","Cuentas Clave (EDI)","Trade","Google Workspace"],
          ...
          { id:"CVP04", code:"CVP04", name:"Compra",
            ...
            erp:["CO","CP","CI","CG"], systems:["Trade","Cuentas Clave (EDI)","Portal Proveedores"],
      ...
      },
      {
        ...
        processes:[
          { id:"CVP07", code:"CVP07", name:"Oferta del Producto",
            desc:"Gestión del portafolio para venta: precios, niveles, descuentos y promociones. Publicación en canales habilitados: AFV 2.0 (fuerza de ventas en ruta), Portal B2R, Catálogo Digital y Cuentas Clave (EDI). Fuente única de datos: Softland ERP.",
            erp:["FA","CI","CC"], systems:["AFV 2.0","Catálogo Digital","Portal B2R","SIM"],
            dms:["DM de Promociones","Cargador de Precios Cofersa","Homologación de Artículos"],
            outputs:["PLN-VEN"] },
          { id:"PLN-VEN", code:"PLN-VEN", name:"Planificación de Ventas",
            desc:"Traducir la estrategia de portafolio en metas comerciales, cuotas, cobertura y recursos. Elaboración de presupuestos por canal, país y marca. Asignación de zonas, rutas y vendedores. Integración con AFV 2.0 (carga de rutas, cuotas y parámetros). Revisión periódica plan vs. ejecución con ciclo de retroalimentación.",
            erp:["FA","CC","CG"], systems:["AFV 2.0","SIM","Power BI / Fabric"],
            dms:["Push Money","Indicadores potencial de venta SIM","Formato SIM"],
            outputs:["VEN"] },
          { id:"VEN", code:"VEN", name:"Ejecución Comercial",
            desc:"Ejecutar el proceso comercial mediante todos los canales habilitados: Canal Tradicional (AFV 2.0) captura offline-first, Portal B2R autogestión del cliente, Cuentas Clave (EDI) OV automática sin intervención manual, Televentas cartera cautiva. Gestión de precios, promociones, descuentos y condiciones especiales. Bloqueo automático de pedidos por límite de crédito.",
            erp:["FA","CI","CC","CG"], systems:["AFV 2.0","Portal B2R","Cuentas Clave (EDI)","Televentas","SIM"],
            dms:["DM de Promociones","DM de Fletes","Cargador de Precios Cofersa"],
            outputs:["COB","CVP14"] },
          { id:"COB", code:"COB", name:"Cobranza y Gestión de Crédito",
            desc:"Garantizar la recuperación oportuna del ingreso. Evaluación y asignación de líneas de crédito. Cobranza en campo integrada con AFV 2.0 (módulo COB): recepción de pagos, foto de comprobante y geolocalización. Alertas automáticas de vencimiento y mora. Bloqueo automático Softland → AFV / Portal B2R cuando el cliente supera el límite de crédito. Dashboard de cartera por vendedor, supervisor y compañía en SIM.",
            erp:["CC","CB","CG","FA"], systems:["AFV 2.0","Portal B2R","Sage XRT","Host to Host","SIM"],
            dms:["DM Conciliaciones","Limpieza de Saldos","Alerta temprana de Cobro"],
            outputs:[] },
          { id:"POS-DEV", code:"POS-DEV", name:"Postventa y Gestión de Devoluciones",
            desc:"Atender oportunamente las incidencias comerciales y logísticas post-entrega. Registro de reclamos en campo vía AFV 2.0 (foto de evidencia, geolocalización). Seguimiento en línea por el cliente desde Portal B2R. Control de devoluciones físicas y generación de notas de crédito en Softland. Medición periódica de satisfacción (NPS por canal). Análisis de causas raíz de incidencias recurrentes.",
            erp:["FA","CC","CI","CG"], systems:["AFV 2.0","Portal B2R","Respond.io","SIM"],
      ...
      },
      {
        ...
        processes:[
          ...
          { id:"CVP15", code:"CVP15", name:"Despacho y Transporte",
            ...
            erp:["FA","CI"], systems:["Torre de Control","WMS ePrac","AFV 2.0","Última milla"],
  ...
  },
  {
    ...
    processes:[
      ...
      { id:"SOP04", code:"SOP04", name:"Comercio exterior",
        ...
        erp:["CO","CI","CP","CG"], systems:["Trade","Cuentas Clave (EDI)","Portal Proveedores"],
